...
export const Home = () => {
	...
	const getStarWarsPlanets = async () => {
		try {
			...
			const data = await response.json();
			dispatch({ type: "add_planet", payload: data.results });
		} catch (error) {
			console.log(error);
		}
	...
	return (
		<div className="container">
			...
			<div className="row flex-nowrap overflow-x-auto">{/* Characters */}
				{store.characters.map((character, characterIndex) => {
					return (
			...
			<div className="row flex-nowrap overflow-x-auto">{/* PLanets */}
				{store.planets.map((planet, planetIndex) => {
					return (
